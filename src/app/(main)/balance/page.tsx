              ...
              <div className="bg-white dark:bg-gray-900 rounded-xl p-4 mb-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className={`text-lg font-bold ${getProfitColor(selectedAccount.summary.holding_profit_amount)}`}>
                  ...
                  <div>
                    ...
                    <div className={`text-lg font-bold ${getProfitColor(selectedAccount.summary.holding_profit_rate)}`}>
